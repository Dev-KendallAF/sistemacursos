        ...
        <div class="dashboard__data">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <label for="txt_nombre" class="dark:text-indigo-500">Nombre Categoría</label>
              <input type="text" name="nombre" id="txt_nombre" mask="char" placeholder="Ingresa el nombre categoría"  value="{{$Curso->nombre}}" autocomplete="off" >
            @error('nombre')
            <span class="message__error"><i class="fa-solid fa-circle-exclamation fa-fade"></i> {{$message}}</span>
            @enderror
            </div>
            <!-- Estado -->
            <div class="switch ml-10" id="switch_estado" data-estado="{{$Curso->estado}}">
