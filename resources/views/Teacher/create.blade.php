  ...
  <x-slot name="content">
    <div class="continer mx-auto ">
      ...
      <div class="historyLink">
        ...
        <a href="{{route('teacher.show', $persona->id) }}" >ver /</a>
      ...
      <div class="dashboard__porfile">
        ...
        <div class="dashboard__data">
          <div>
            <a href="{{route('teacher.show', $persona )}}"><i class="fa-solid fa-circle-chevron-left mx-2 pb-2 fa-lg text-indigo-600"></i></a>
            <h1 class="inline text-2xl font-bold text-indigo-600" >Regresar</h1>
          </div>
          <hr class="my-3">

          <form action="{{route('teacher.update', $persona ) }}" method="POST">
