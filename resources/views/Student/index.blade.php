@php $hName='Estudiantes' @endphp

<x-layouts.panel  headerName="{{$hName}}" index='4'>
  <x-slot name="content">
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td data-label="Estado" class="estado {{ $p->estado == 1 ? 'estado__activo' : 'estado__inactivo' }}">
                        {{ $p->estado == 1 ? 'Activo' : 'Inactivo' }}
                          ...
                          <a href="{{ route('student.show', $p) }}"><i class="fa-solid fa-user-large"></i></a>
                          <a href="{{ route('student.edit', $p) }}"><i class="fa-solid fa-user-pen"></i></a>
                      </td>
                  </tr>
              @endforeach
          </tbody>
